# n8n-nodes-leafengines — Agricultural Intelligence for n8n

**Soil analysis, crop recommendations, and environmental intelligence** for n8n business automation. Patent-protected algorithms. Works with free test key — no signup required.
...
Transform n8n into an agricultural intelligence platform:
...
- **Environmental Impact** — Sustainability metrics, compliance reporting
...
**Free tier (immediate):**
- API Endpoint: `https://wzgnxkoeqzvueypwzvyn.supabase.co/functions/v1/get-soil-data`
- Add header: `x-free-tier: true`
- No API key needed

**Test key (immediate):**
- API key: `leaf-test-370df0a2e62e`
- API Endpoint: `https://wzgnxkoeqzvueypwzvyn.supabase.co/functions/v1/get-soil-data`

**Production:**
- [Subscribe →](https://buy.stripe.com/14A7sL30y8bR2F4fbgaMU02) for instant API key via Stripe checkout
...
|--------|-------------|--------------|----------------------|
| **United States** | $10/$25/$50 | $149/$499/$1999 | Card, Apple Pay, Google Pay, Affirm |
...
- **[Node-RED](https://www.npmjs.com/package/node-red-contrib-leafengines)** — IoT/edge automation
...
- **Multi-source data fusion** — Combine soil, water, weather, satellite data
- **Enterprise integration** — Connect to CRMs, ERPs, compliance systems
