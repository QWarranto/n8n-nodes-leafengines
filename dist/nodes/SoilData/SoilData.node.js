...
class SoilData {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                const countyFips = this.getNodeParameter('countyFips', i);
                ...
                const cacheBehavior = this.getNodeParameter('cacheBehavior', i);
                ...
                const responseData = await GenericFunctions_1.leafEnginesApiRequest.call(this, {
                    method: 'POST',
                    url: endpoint,
                    body,
                });
                ...
                if (this.continueOnFail()) {
                    returnData.push({
                        json: {
                            error: error.message,
                            itemIndex: i,
                            countyFips: this.getNodeParameter('countyFips', i, ''),
                            operation,
...
//# sourceMappingURL=SoilData.node.js.map